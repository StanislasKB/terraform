###############################################################
# Environnement STAGING - Variables
###############################################################
...
# --- SSH ---
# Injectée depuis GitHub Secrets via : terraform apply -var="ssh_public_key=${{ secrets.EC2_SSH_PUBLIC_KEY }}"
# Ne JAMAIS mettre cette valeur dans terraform.tfvars
...
# --- AMI ---
variable "ami_id" {
  description = "ID de l'AMI (Ubuntu 22.04 LTS recommandé)"
  type        = string
}
